...
import {CargarCreditosDigitalesService} from '../../cargar-creditos-digitales.service';
...
@Component({
  selector: 'app-upload',
  templateUrl: './upload-digitales.component.html',
  styleUrls: ['./upload.component-digitales.scss']
})
export class UploadDigitalesComponent implements OnInit, OnDestroy {
  ...
  constructor(
    private _cargarCreditosEmpleados: CargarCreditosDigitalesService,
  ...
  guardar() {
    ...
    this.nuevoArchivo.append('tipoCredito', 'Credito Consumo Empleado-PreAprobado');
    this.nuevoArchivo.append('empresa_financiera', this.idEmpresa);
