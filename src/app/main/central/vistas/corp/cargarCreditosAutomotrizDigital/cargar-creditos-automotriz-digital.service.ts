...
export class CargarCreditosAutomotrizDigitalService {
  ...
  subirArchivosPreAprobados(id) {
    return this._httpClient.post<any>(`${environment.apiUrl}/corp/creditoArchivos/upload/creditos/preaprobadosAutomotrizDigitales/empleados/${id}`, {});
  }
}
