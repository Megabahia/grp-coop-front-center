...
@Component({
    selector: 'app-empleados-center-automotriz-digital',
    templateUrl: './solicitudes-empleados-center-automotriz-digital.component.html',
    styleUrls: ['./solicitudes-empleados-center-automotriz-digital.component.scss'],
    providers: [DatePipe],
})
export class SolicitudesEmpleadosCenterAutomotrizDigitalComponent implements OnInit, AfterViewInit {
    ...
    obtenerSolicitudesCreditos() {
        this._solicitudCreditosService.obtenerSolicitudesCreditos({
            ...
            page: this.page - 1,
            tipoCredito: 'Credito Automotriz Digital Empleado',
            cargarOrigen: 'IFIS',
            alcance: 'LOCAL',
        }).subscribe(info => {
