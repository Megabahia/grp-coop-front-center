...
@Component({
  selector: 'app-alfa-center-automotriz-digital',
  templateUrl: './alfa-center-automotriz-digital.component.html',
  styleUrls: ['./alfa-center-automotriz-digital.component.scss'],
  providers: [DatePipe],
})
export class AlfaCenterAutomotrizDigitalComponent implements OnInit, AfterViewInit {
  ...
  obtenerSolicitudesCreditos() {
    this._solicitudCreditosService.obtenerSolicitudesCreditos({
      ...
      page: this.page - 1,
      tipoCredito: 'Credito Automotriz Digital Alfa',
      cargarOrigen: 'IFIS'
    }).subscribe(info => {
