...
@Component({
  selector: 'app-negocio-propio-preaprovados-center-automotriz-digital',
  templateUrl: './negocio-propio-preaprovados-center-automotriz-digital.component.html',
  styleUrls: ['./negocio-propio-preaprovados-center-automotriz-digital.component.scss'],
  providers: [DatePipe],
})
export class NegocioPropioPreaprovadosCenterAutomotrizDigitalComponent implements OnInit, AfterViewInit {
  ...
  obtenerSolicitudesCreditos() {
    this._solicitudCreditosService.obtenerSolicitudesCreditos({
      ...
      page: this.page - 1,
      tipoCredito: 'Credito Automotriz Digital Negocio-PreAprobado',
      cargarOrigen: 'IFIS',
      alcance: 'LOCAL',
    }).subscribe(info => {
