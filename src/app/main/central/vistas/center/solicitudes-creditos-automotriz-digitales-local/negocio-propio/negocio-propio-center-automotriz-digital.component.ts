...
@Component({
  selector: 'app-negocio-propio-center-automotriz-digital',
  templateUrl: './negocio-propio-center-automotriz-digital.component.html',
  styleUrls: ['./negocio-propio-center-automotriz-digital.component.scss'],
  providers: [DatePipe],
})
export class NegocioPropioCenterAutomotrizDigitalComponent implements OnInit, AfterViewInit {
  ...
  obtenerSolicitudesCreditos() {
    this._solicitudCreditosService.obtenerSolicitudesCreditos({
      ...
      page: this.page - 1,
      tipoCredito: 'Credito Automotriz Digital Negocio propio',
      cargarOrigen: 'IFIS',
      alcance: 'LOCAL',
    }).subscribe(info => {
