...
@Component({
  selector: 'app-empleados-preaprovados-center-automotriz-digital',
  templateUrl: './empleados-preaprovados-center-automotriz-digital.component.html',
  styleUrls: ['./empleados-preaprovados-center-automotriz-digital.component.scss'],
  providers: [DatePipe],
})
export class EmpleadosPreaprovadosCenterAutomotrizDigitalComponent implements OnInit, AfterViewInit {
  ...
  obtenerSolicitudesCreditos() {
    this._solicitudCreditosService.obtenerSolicitudesCreditos({
      ...
      page: this.page - 1,
      tipoCredito: 'Credito Automotriz Digital Empleado-PreAprobado',
      cargarOrigen: 'IFIS',
      alcance: 'LOCAL',
    }).subscribe(info => {
