...
@Component({
    ...
    templateUrl: './microcreditos-pre-aprovados-center-digital.component.html',
    styleUrls: ['./microcreditos-pre-aprovados-center-digital.component.scss'],
    providers: [DatePipe],

})
export class MicrocreditosPreAprovadosCenterDigitalComponent implements OnInit, AfterViewInit {
