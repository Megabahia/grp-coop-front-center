...
@Component({
  ...
  templateUrl: './microcreditos-normales-center-digital.component.html',
  styleUrls: ['./microcreditos-normales-center-digital.component.scss'],
  providers: [DatePipe],
})
export class MicrocreditosNormalesCenterDigitalComponent implements OnInit, AfterViewInit {
