...
@Component({
    selector: 'app-alfa-preaprovados-center',
    templateUrl: './alfa-preaprovados-center-digital.component.html',
    styleUrls: ['./alfa-preaprovados-center-digital.component.scss'],
    providers: [DatePipe],
})
export class AlfaPreaprovadosCenterDigitalComponent implements OnInit, AfterViewInit {
