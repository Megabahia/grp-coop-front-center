...
@Component({
    ...
    templateUrl: './negocio-propio-preaprovados-center-digital.component.html',
    styleUrls: ['./negocio-propio-preaprovados-center-digital.component.scss'],
    providers: [DatePipe],
})
export class NegocioPropioPreaprovadosCenterDigitalComponent implements OnInit, AfterViewInit {
