...
@Component({
  ...
  templateUrl: './empleados-preaprovados-center-digital.component.html',
  styleUrls: ['./empleados-preaprovados-center-digital.component.scss'],
  providers: [DatePipe],
})
export class EmpleadosPreaprovadosCenterDigitalComponent implements OnInit, AfterViewInit {
