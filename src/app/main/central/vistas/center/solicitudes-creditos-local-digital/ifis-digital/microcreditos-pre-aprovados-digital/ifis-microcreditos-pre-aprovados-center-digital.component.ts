...
@Component({
    ...
    templateUrl: './ifis-microcreditos-pre-aprovados-center-digital.component.html',
    styleUrls: ['./ifis-microcreditos-pre-aprovados-center-digital.component.scss'],
    providers: [DatePipe],

})
export class IfisMicrocreditosPreAprovadosCenterDigitalComponent implements OnInit, AfterViewInit {
