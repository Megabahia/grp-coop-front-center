...
@Component({
    ...
    templateUrl: './ifis-negocio-propio-preaprovados-center-digital.component.html',
    styleUrls: ['./ifis-negocio-propio-preaprovados-center-digital.component.scss'],
    providers: [DatePipe],
})
export class IfisNegocioPropioPreaprovadosCenterDigitalComponent implements OnInit, AfterViewInit {
