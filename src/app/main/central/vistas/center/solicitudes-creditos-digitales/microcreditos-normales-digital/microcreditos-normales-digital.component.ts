...
@Component({
    ...
    templateUrl: './microcreditos-normales-digital.component.html',
    styleUrls: ['./microcreditos-normales-digital.component.scss'],
    providers: [DatePipe],

})
export class MicrocreditosNormalesDigitalComponent implements OnInit, AfterViewInit {
