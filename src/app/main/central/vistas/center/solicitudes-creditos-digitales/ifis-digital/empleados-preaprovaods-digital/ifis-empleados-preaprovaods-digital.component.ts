...
@Component({
  ...
  templateUrl: './ifis-empleados-preaprovaods-digital.component.html',
  styleUrls: ['./ifis-empleados-preaprovaods-digital.component.scss'],
  providers: [DatePipe],
})
export class IfisEmpleadosPreaprovaodsDigitalComponent implements OnInit, AfterViewInit {
