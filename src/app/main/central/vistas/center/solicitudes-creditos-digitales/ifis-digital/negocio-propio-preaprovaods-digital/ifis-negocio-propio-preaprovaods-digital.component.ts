...
@Component({
  ...
  templateUrl: './ifis-negocio-propio-preaprovaods-digital.component.html',
  styleUrls: ['./ifis-negocio-propio-preaprovaods-digital.component.scss'],
  providers: [DatePipe],

})
export class IfisNegocioPropioPreaprovaodsDigitalComponent implements OnInit, AfterViewInit {
