...
@Component({
  ...
  templateUrl: './ifis-microcreditos-pre-aprovados-digital.component.html',
  styleUrls: ['./ifis-microcreditos-pre-aprovados-digital.component.scss'],
  providers: [DatePipe],

})
export class IfisMicrocreditosPreAprovadosDigitalComponent implements OnInit, AfterViewInit {
  ...
  obtenerSolicitudesCreditos() {
    this._solicitudCreditosService.obtenerSolicitudesCreditos({
      ...
      page: this.page - 1,
      tipoCredito: 'Credito Consumo Pymes-PreAprobado',
      cargarOrigen: 'IFIS',
