...
@Component({
  ...
  templateUrl: './negocio-propio-preaprovaods-digital.component.html',
  styleUrls: ['./negocio-propio-preaprovaods-digital.component.scss'],
  providers: [DatePipe],

})
export class NegocioPropioPreaprovaodsDigitalComponent implements OnInit, AfterViewInit {
