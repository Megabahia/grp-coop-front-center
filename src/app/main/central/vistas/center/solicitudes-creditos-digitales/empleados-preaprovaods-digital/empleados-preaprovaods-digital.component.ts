...
@Component({
  ...
  templateUrl: './empleados-preaprovaods-digital.component.html',
  styleUrls: ['./empleados-preaprovaods-digital.component.scss'],
  providers: [DatePipe],
})
export class EmpleadosPreaprovaodsDigitalComponent implements OnInit, AfterViewInit {
