...
@Component({
  ...
  templateUrl: './microcreditos-pre-aprovados-digital.component.html',
  styleUrls: ['./microcreditos-pre-aprovados-digital.component.scss'],
  providers: [DatePipe],

})
export class MicrocreditosPreAprovadosDigitalComponent implements OnInit, AfterViewInit {
