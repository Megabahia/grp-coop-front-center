...
@Component({
  ...
  templateUrl: './empleados-digital.component.html',
  styleUrls: ['./empleados-digital.component.scss'],
  providers: [DatePipe],
})
export class EmpleadosDigitalComponent implements OnInit, AfterViewInit {
