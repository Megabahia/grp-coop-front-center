...
@Component({
  ...
  templateUrl: './ifis-empleados-preaprovaods-automotriz.component.html',
  styleUrls: ['./ifis-empleados-preaprovaods-automotriz.component.scss'],
  providers: [DatePipe],
})
export class IfisEmpleadosPreaprovaodsAutomotrizComponent implements OnInit, AfterViewInit {
