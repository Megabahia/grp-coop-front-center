...
@Component({
  ...
  templateUrl: './ifis-microcreditos-pre-aprovados-automotriz.component.html',
  styleUrls: ['./ifis-microcreditos-pre-aprovados-automotriz.component.scss'],
  providers: [DatePipe],

})
export class IfisMicrocreditosPreAprovadosAutomotrizComponent implements OnInit, AfterViewInit {
  ...
  obtenerSolicitudesCreditos() {
    this._solicitudCreditosService.obtenerSolicitudesCreditos({
      ...
      page: this.page - 1,
      tipoCredito: 'Credito Automotriz Pymes-PreAprobado',
      cargarOrigen: 'IFIS',
  ...
  actualizarSolicitudCredito(estado?: string) {
    ...
    this.checks = [
      ...
      {
        'label': '3 Copias de Facturas de Ventas del negocio de los últimos 2 meses',
        'valor': resto.checkfacturasVentas2meses
      },
      {
