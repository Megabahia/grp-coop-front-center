...
@Component({
  ...
  templateUrl: './ifis-negocio-propio-preaprovaods-automotriz.component.html',
  styleUrls: ['./ifis-negocio-propio-preaprovaods-automotriz.component.scss'],
  providers: [DatePipe],

})
export class IfisNegocioPropioPreaprovaodsAutomotrizComponent implements OnInit, AfterViewInit {
