...
@Component({
  ...
  templateUrl: './negocio-propio-preaprovaods-automotriz.component.html',
  styleUrls: ['./negocio-propio-preaprovaods-automotriz.component.scss'],
  providers: [DatePipe],

})
export class NegocioPropioPreaprovaodsAutomotrizComponent implements OnInit, AfterViewInit {
