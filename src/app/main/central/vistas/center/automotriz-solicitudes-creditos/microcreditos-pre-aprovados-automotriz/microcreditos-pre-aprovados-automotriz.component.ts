...
@Component({
  ...
  templateUrl: './microcreditos-pre-aprovados-automotriz.component.html',
  styleUrls: ['./microcreditos-pre-aprovados-automotriz.component.scss'],
  providers: [DatePipe],

})
export class MicrocreditosPreAprovadosAutomotrizComponent implements OnInit, AfterViewInit {
