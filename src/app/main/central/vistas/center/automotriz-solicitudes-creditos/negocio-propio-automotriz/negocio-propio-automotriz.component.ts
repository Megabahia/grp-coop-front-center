...
@Component({
  ...
  templateUrl: './negocio-propio-automotriz.component.html',
  styleUrls: ['./negocio-propio-automotriz.component.scss'],
  providers: [DatePipe]
})
export class NegocioPropioAutomotrizComponent implements OnInit, AfterViewInit {
