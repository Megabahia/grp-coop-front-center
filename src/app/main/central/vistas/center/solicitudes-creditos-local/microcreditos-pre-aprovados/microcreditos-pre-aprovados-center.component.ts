...
@Component({
    ...
    templateUrl: './microcreditos-pre-aprovados-center.component.html',
    styleUrls: ['./microcreditos-pre-aprovados-center.component.scss'],
    providers: [DatePipe],

})
export class MicrocreditosPreAprovadosCenterComponent implements OnInit, AfterViewInit {
