...
@Component({
  selector: 'app-alfa-automotriz-digital',
  templateUrl: './alfa-automotriz-digital.component.html',
  styleUrls: ['./alfa-automotriz-digital.component.scss'],
  providers: [DatePipe],
})
export class AlfaAutomotrizDigitalComponent implements OnInit, AfterViewInit {
