...
@Component({
  selector: 'app-negocio-propio-preaprovaods-automotriz-digital',
  templateUrl: './negocio-propio-preaprovaods-automotriz-digital.component.html',
  styleUrls: ['./negocio-propio-preaprovaods-automotriz-digital.component.scss'],
  providers: [DatePipe],

})
export class NegocioPropioPreaprovaodsAutomotrizDigitalComponent implements OnInit, AfterViewInit {
