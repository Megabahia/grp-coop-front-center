...
@Component({
  selector: 'app-valores-proceso-automotriz-digital',
  templateUrl: './valores-proceso-automotriz-digital.component.html',
  styleUrls: ['./valores-proceso-automotriz-digital.component.scss']
})
export class ValoresProcesoAutomotrizDigitalComponent implements OnInit {
