...
@Component({
  selector: 'app-empleados-preaprovaods-automotriz-digital',
  templateUrl: './empleados-preaprovaods-automotriz-digital.component.html',
  styleUrls: ['./empleados-preaprovaods-automotriz-digital.component.scss'],
  providers: [DatePipe],
})
export class EmpleadosPreaprovaodsAutomotrizDigitalComponent implements OnInit, AfterViewInit {
