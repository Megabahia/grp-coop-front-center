...
@Component({
  selector: 'app-negocio-propio-automotriz-digital',
  templateUrl: './negocio-propio-automotriz-digital.component.html',
  styleUrls: ['./negocio-propio-automotriz-digital.component.scss'],
  providers: [DatePipe]
})
export class NegocioPropioAutomotrizDigitalComponent implements OnInit, AfterViewInit {
