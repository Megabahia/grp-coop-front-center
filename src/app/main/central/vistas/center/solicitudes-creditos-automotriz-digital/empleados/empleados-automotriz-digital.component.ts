...
@Component({
  selector: 'app-empleados-automotriz-digital',
  templateUrl: './empleados-automotriz-digital.component.html',
  styleUrls: ['./empleados-automotriz-digital.component.scss'],
  providers: [DatePipe],
})
export class EmpleadosAutomotrizDigitalComponent implements OnInit, AfterViewInit {
