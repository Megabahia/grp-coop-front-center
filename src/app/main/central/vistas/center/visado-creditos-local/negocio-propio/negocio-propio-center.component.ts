...
@Component({
    ...
    templateUrl: './negocio-propio-center.component.html',
    styleUrls: ['./negocio-propio-center.component.scss'],
    providers: [DatePipe],
})
export class NegocioPropioCenterComponent implements OnInit, AfterViewInit {
